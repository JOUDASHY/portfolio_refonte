          ...
          <div className="flex flex-col items-start sm:items-end gap-3">
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              {profile?.link_whatsapp && (
                <a href={`https://wa.me/${profile.link_whatsapp.replace(/\D/g, "")}`} target="_blank" rel="noreferrer noopener" aria-label="WhatsApp" className="rounded-full bg-[#f68c09] p-2 text-white hover:bg-[#f68c09]/80 transition-colors">
