...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative min-h-screen py-20 overflow-hidden border-b-2" style={{ background: 'var(--background)', borderColor: getAdaptiveBorderColor(isDark), boxShadow: getAdaptiveShadow(isDark) }}>
              ...
              <div className="relative bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-accent/20">
                ...
                <div className="grid grid-cols-1 gap-3">
                  {profile?.link_linkedin && (
                    <a href={profile.link_linkedin} target="_blank" rel="noreferrer noopener" className="flex items-center gap-3 p-4 bg-navy/5 rounded-2xl hover:bg-navy/10 hover:border-accent/30 border border-transparent transition-all group">
                  ...
                  {profile?.link_github && (
                    <a href={profile.link_github} target="_blank" rel="noreferrer noopener" className="flex items-center gap-3 p-4 bg-navy/5 rounded-2xl hover:bg-navy/10 hover:border-accent/30 border border-transparent transition-all group">
                      <div className="w-10 h-10 bg-navy rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                        <svg className="w-5 h-5 text-accent" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {profile?.link_facebook && (
                    <a href={profile.link_facebook} target="_blank" rel="noreferrer noopener" className="flex items-center gap-3 p-4 bg-navy/5 rounded-2xl hover:bg-navy/10 hover:border-accent/30 border border-transparent transition-all group">
                      <div className="w-10 h-10 bg-navy rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                        <svg className="w-5 h-5 text-accent" fill="currentColor" viewBox="0 0 24 24">
