...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="relative bg-[var(--about-bg)] py-16 sm:py-20 lg:py-24"
        ...
        <div className="rounded-2xl sm:rounded-3xl border border-accent/30 bg-navy p-4 sm:p-6 lg:p-8 shadow-[0_10px_40px_rgba(0,0,0,0.25)]">
          ...
          <div className="mt-6 sm:mt-8 flex flex-wrap gap-2 sm:gap-3">
            <a href="https://linkedin.com" target="_blank" rel="noreferrer noopener" className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full bg-white/10 px-3 sm:px-5 py-1.5 sm:py-2 text-white ring-1 ring-white/20 hover:bg-white/15 transition-all duration-200">
              ...
              <span className="text-var-caption sm:text-sm">Connect</span>
            </a>
            <a href="#" className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full bg-white/10 px-3 sm:px-5 py-1.5 sm:py-2 text-white ring-1 ring-white/20 hover:bg-white/15 transition-all duration-200">
              <span className="inline-block h-1.5 w-1.5 sm:h-2 sm:w-2 rounded-full bg-accent" />
              <span className="text-var-caption sm:text-sm">Follow</span>
            </a>
