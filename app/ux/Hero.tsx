...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Blue tint overlay */}
      <div className="absolute inset-0 bg-[#000b31]/68 z-[1]" />
      ...
      <div className="relative z-20 mx-auto grid max-w-7xl grid-cols-1 gap-8 sm:gap-12 lg:grid-cols-2 lg:gap-16 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col justify-center py-8 sm:py-12 order-2 lg:order-1 -mt-12 sm:-mt-16 lg:-mt-20">
          ...
          <p className="mt-3 sm:mt-4 text-xl xs:text-2xl sm:text-3xl lg:text-4xl font-semibold text-white">
          ...
          <div className="mt-6 sm:mt-8 lg:mt-10">
            <a
              href="#about"
              className="inline-flex items-center gap-2 sm:gap-3 rounded-full bg-white/10 px-4 sm:px-6 py-2 sm:py-3 text-white hover:bg-white/15 ring-1 ring-white/20 transition-all duration-200"
            >
